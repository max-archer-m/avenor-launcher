    ...
    @Test fun recreationDuringWriteWaitsForCompletePersistedState() {
        ...
        try {
            composeRule.setContent {
                AvenorTheme { AvenorApp(inventoryLoader = loader, drawerDisplaySettingsStore = oldStore) }
            }
            ...
            composeRule.activityRule.scenario.onActivity { activity ->
                activity.setContent {
                    AvenorTheme {
                        AvenorApp(inventoryLoader = loader, drawerDisplaySettingsStore = recreatedStore)
                    }
                }
            }
