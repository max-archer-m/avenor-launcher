...
- [Home](wireframes/home.txt) — complete canvas showing fixed basic information, the dismissible default-Launcher prompt shown between that region and the list while Avenor is not the default Launcher, and the vertically scrolling heterogeneous favorite main list with representative peer modules.
