...
- Multi-selection rows reuse the ordinary inventory's items-per-row grid and arrangements; row geometry matches ordinary Content, and the selection state changes no layout.
