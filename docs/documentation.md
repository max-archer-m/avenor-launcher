...
| 1.2.0 completed delivery | [`docs/delivery/1.2.0/delivery.md`](delivery/1.2.0/delivery.md) | [`docs/delivery/1.2.0/delivery.zh-CN.md`](delivery/1.2.0/delivery.zh-CN.md) | Delivery history | Records the closed Iterations 12-14 boundary, identifiers, available artifact evidence, validation gaps, and author disposition |
