...
| 1.2.0 planned delivery | [`docs/delivery/1.2.0/delivery.md`](delivery/1.2.0/delivery.md) | [`docs/delivery/1.2.0/delivery.zh-CN.md`](delivery/1.2.0/delivery.zh-CN.md) | Delivery records | Records the currently selected version scope, included iteration states, evidence, dependencies, validation, and eventual result; further author-confirmed iterations may be added |
