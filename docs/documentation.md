...
| 1.1.0 planned delivery | [`docs/delivery/1.1.0/delivery.md`](delivery/1.1.0/delivery.md) | [`docs/delivery/1.1.0/delivery.zh-CN.md`](delivery/1.1.0/delivery.zh-CN.md) | Delivery records | Selects full-width primary-favorite editing, application shortcuts, basic Settings, optional double-tap lock, static-name cleanup, and version closure as the next author daily-use baseline |
