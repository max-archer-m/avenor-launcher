...
- Current candidate version identity: `versionName 1.4.0`, configured `versionCode 5`; artifact allocation and acceptance are recorded in [1.4.0 delivery](delivery/1.4.0/delivery.md).
