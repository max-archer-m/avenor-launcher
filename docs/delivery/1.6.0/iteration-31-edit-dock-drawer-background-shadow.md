...
Deliver four author-accepted reworks exactly as defined by the accepted product contracts: the Home edit dock moved to the top of safe content with the purely presentational panel slot-swap animation, the Drawer background reworked into one continuous background-opacity percentage slider with a percentage readout and no switch, blur, or fallback, the shared style settings panel edge shadow, and the favorite multi-selection presentation redefined with unified overlay badges.

## Product and version references

- Product-contract baseline: `32d7d25a0fed9e1784518c85796b5f38d18960fc` — the commit that integrates the accepted 2026-09-09 background-opacity contract revision, which supersedes the Drawer-background portion of `7af7adba15b018886dd613c587dfedd9299136b4`; the edit-dock, panel-shadow, and favorite-multi-selection revisions of that commit remain included.
- Applicable product documents:
  ...
  - [Style settings panel presentation](../../product/presentation/style-settings-panel.md), including the readout-and-slider row and edge shadow values
...
- Focused test sources covering dock placement and hot-zone stability, animation interruption and retargeting, slider mapping and release-commit behavior, interruption reversion, migration of prior background values, and shadow realization.
...
- [Style settings panel presentation](../../product/presentation/style-settings-panel.md) — the readout-and-slider row and edge shadow values.
