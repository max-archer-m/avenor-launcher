...
- Product-contract baseline: `86edf562f1b27db501bb8d602cd09897753fc691` — the commit that integrates the accepted 2026-09-09 edit-dock and panel-slot-swap presentation refinements; the multi-selection, edge-border, Drawer-panel-animation, edit-dock, Drawer-background, and favorite-multi-selection revisions of the earlier baselines remain included.
