...
- Product-contract baseline: `212b8b569461169a82346562f865ae3f113f3aec` — the commit that integrates the accepted 2026-09-09 multi-selection presentation refinements; the edge-border, Drawer-panel-animation, edit-dock, Drawer-background, and favorite-multi-selection revisions of the earlier baselines remain included.
