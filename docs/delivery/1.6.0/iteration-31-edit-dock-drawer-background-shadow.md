...
- Product-contract baseline: `68d8a9afeb81e43648caacb43bfdd05c0a754596` — the commit that integrates the accepted 2026-09-09 background readout alignment presentation refinement; the edit-dock, panel-slot-swap, multi-selection, edge-border, Drawer-panel-animation, edit-dock, Drawer-background, and favorite-multi-selection revisions of the earlier baselines remain included.
...
- 2026-09-09: Author-directed amendment. The author refined the multi-selection presentation during device acceptance: multi-selection rows show no press Ripple, with the selection scale and outline treatment as their visible response, and the order badge carries `4dp` horizontal content padding inside its approximately `20dp` adaptive minimum size. Previous boundary: the multi-selection rows as defined under baseline `4f596a5fe9de30785dd0e06c2f66a727e481bb9a` without press-feedback or badge-padding definitions. New boundary: the multi-selection presentation definitions recorded in the Drawer presentation specification; the baseline moves to `212b8b569461169a82346562f865ae3f113f3aec`, the commit integrating those presentation revisions. Affected obligations: the Drawer presentation specification records both definitions; the iteration identifier and file slug remain unchanged.
- 2026-09-09: Author-directed amendment. The author refined the edit-dock presentation during device acceptance: an `8dp` spacing separates the expanded style settings panel from the favorite main-list viewport, and the edit dock instruction text carries one fixed dark text shadow with the Drawer foreground shadow parameters (black `65%`, `0dp` horizontal offset, `1dp` vertical offset, `2dp` blur radius). Previous boundary: the panel and the main list adjoined without a defined spacing and the instruction text carried no shadow under baseline `212b8b569461169a82346562f865ae3f113f3aec`. New boundary: both definitions recorded in the Home presentation specification; the baseline moves to `86edf562f1b27db501bb8d602cd09897753fc691`, the commit integrating those presentation revisions. Affected obligations: the Home presentation specification records both definitions; the iteration identifier and file slug remain unchanged.
- 2026-09-09: Author-directed amendment. The author refined the background readout presentation during device acceptance: the readout text is center-aligned within its fixed-width reservation. Previous boundary: the readout text start-aligned under baseline `86edf562f1b27db501bb8d602cd09897753fc691`. New boundary: the center-aligned readout recorded in the style settings panel presentation specification; the baseline moves to `68d8a9afeb81e43648caacb43bfdd05c0a754596`, the commit integrating that presentation revision. Affected obligations: the style settings panel presentation specification records the alignment; the iteration identifier and file slug remain unchanged.
